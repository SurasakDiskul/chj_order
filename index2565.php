...
WHERE datecro BETWEEN '2565-01-01' AND '2565-01-31'";
...
WHERE datecro BETWEEN '2565-02-01' AND '2565-02-29'";
...
WHERE datecro BETWEEN '2565-03-01' AND '2565-03-31'";
...
WHERE datecro BETWEEN '2565-04-01' AND '2565-04-30'";
...
WHERE datecro BETWEEN '2565-05-01' AND '2565-05-31'";
...
WHERE datecro BETWEEN '2565-06-01' AND '2565-06-30'";
...
WHERE datecro BETWEEN '2565-07-01' AND '2565-07-31'";
...
WHERE datecro BETWEEN '2565-08-01' AND '2565-08-31'";
...
WHERE datecro BETWEEN '2565-09-01' AND '2565-09-30'";
...
WHERE datecro BETWEEN '2565-10-01' AND '2565-10-31'";
...
WHERE datecro BETWEEN '2565-11-01' AND '2565-11-30'";
...
WHERE datecro BETWEEN '2565-12-01' AND '2565-12-31'";
...
<!--Content Start-->
    <div class="container-fluid position-relative ">
        ...
        <!--Highchart-->
            ...
            <div class="col-1">
                <a type="button" href="./index.php" class="btn btn-primary">2565</a>
            </div>
                <div class="col-5"></div>
            </div>
