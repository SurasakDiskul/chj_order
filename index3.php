...
<!-----------------------------------------------------1-------------------------------------------------------------------------->
<?php 
    $res1 = mysqli_query($conn,'SELECT remark, COUNT( quantity )FROM `tbproadd`GROUP BY remark ORDER BY COUNT( quantity ) DESC LIMIT 1;');
...
<?php
//<!-----------------------------------------------------0------------------------------------------------------------------>
$sql_re1 = "SELECT customername, SUM( amount )FROM `tbcro` WHERE datecro BETWEEN '2566-06-01' AND '2566-06-30' GROUP BY customername ORDER BY SUM( amount ) DESC LIMIT 5 OFFSET 0";
...
<?php
//<!-----------------------------------------------------0------------------------------------------------------------------>
$sql_re2 = "SELECT customername, SUM( amount )FROM `tbcro` WHERE datecro BETWEEN '2566-06-01' AND '2566-06-30' GROUP BY customername ORDER BY SUM( amount ) DESC LIMIT 5 OFFSET 1;";
...
<?php
//<!-----------------------------------------------------0------------------------------------------------------------------>
$sql_re3 = "SELECT customername, SUM( amount )FROM `tbcro` WHERE datecro BETWEEN '2566-06-01' AND '2566-06-30' GROUP BY customername ORDER BY SUM( amount ) DESC LIMIT 5 OFFSET 2;";
...
<?php
//<!-----------------------------------------------------0------------------------------------------------------------------>
$sql_re4 = "SELECT customername, SUM( amount )FROM `tbcro` WHERE datecro BETWEEN '2566-06-01' AND '2566-06-30' GROUP BY customername ORDER BY SUM( amount ) DESC LIMIT 5 OFFSET 3;";
...
<?php
//<!-----------------------------------------------------0------------------------------------------------------------------>
$sql_re5 = "SELECT customername, SUM( amount )FROM `tbcro` WHERE datecro BETWEEN '2566-06-01' AND '2566-06-30' GROUP BY customername ORDER BY SUM( amount ) DESC LIMIT 5 OFFSET 4;";
...
Highcharts.chart('container', {
    ...
    title: {
        align: 'left',
        text: 'ลูกค้าที่คืนสินค้ามูลค่าสูงที่สุด ภายในเดือน มิถุนายน 2566'
    },
    subtitle: {
        align: 'left',
    ...
    tooltip: {
        headerFormat: '',
        pointFormat: ' <b>{point.y}</b> บาท<br/>'
    },
    ...
    series: [
        {
            ...
            data: [
                {
                    name: '<?php echo $row_re1['customername'] ;?>',
                    y: <?php echo $row_re1['SUM( amount )'] ;?>,
                    
                },
                {
                    name: '<?php echo $row_re2['customername'] ;?>',
                    y: <?php echo $row_re2['SUM( amount )'] ;?>,
                    
                },
                {
                    name: '<?php echo $row_re3['customername'] ;?>',
                    y: <?php echo $row_re3['SUM( amount )'] ;?>,
                    
                },
                {
                    name: '<?php echo $row_re4['customername'] ;?>',
                    y: <?php echo $row_re4['SUM( amount )'] ;?>,
                    
                },
                {
                    name: '<?php echo $row_re5['customername'] ;?>',
                    y: <?php echo $row_re5['SUM( amount )'] ;?>,
                }
            ]
        }
    ]
